      ...
      <div class="columns">
        <div class="column is-6 is-offset-3">
          <div class="token-image mb-40">
            <img src="@/assets/img/coins/Tezos-coin-XTZ-symbol.svg">
          </div>
          <br>
          <h1 class="title is-2 is-light is-semibold is-spaced main-title">Tezos Bakery</h1>
          <h2 class="subtitle is-5 is-light is-thin">
            Cryptocurrency brought to the next level. Join our Bakery for supercharged rewards.
          </h2>
          <!-- CTA -->
          <p>
          ...
          <div class="columns is-vcentered">
            ...
            <div class="column is-5 is-offset-1">
              <div class="side-feature-content">
                ...
                <h3 class="title is-4 is-light">Network Govaynance</h3>
